inat_ggplot <- function(place, titleplace, filename, colx, coly){
...
# inat_ggplot(inat_esqlag, "Esquimalt Lagoon", "./inst/extdata/inat_ggplot_bw.jpg", inat_esqlag$scientific_name, inat_esqlag$date)
