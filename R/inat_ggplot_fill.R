inat_ggplot_fill <- function(place, titleplace, filename, colx, coly, colfill){
...
# inat_ggplot_fill(inat_esqlag, "Esquimalt Lagoon", "./inst/extdata/inat_ggplot.jpg", inat_esqlag$scientific_name, inat_esqlag$date, inat_esqlag$Genus)
